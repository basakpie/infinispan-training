...
set "JAVA_OPTS=%JAVA_OPTS% -Djboss.server.default.config=clustered-store.xml"

rem # Set the default jboss binding port and jgroups stack setting
set "JAVA_OPTS=%JAVA_OPTS% -Djboss.default.jgroups.stack=tcp -Djboss.socket.binding.port-offset=100"

rem # Set the default jboss bind address
set "JAVA_OPTS=%JAVA_OPTS% -Djboss.bind.address=127.0.0.1 -Djboss.bind.address.management=127.0.0.1 -Djboss.node.name=nodeA"
